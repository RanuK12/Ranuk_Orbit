...
// Build the client-side asset allowlist from the files that are actually
// committed. This is a safety net for a media-first site: an outdated manual
// manifest makes the gallery advertise clips that return 404 in production.
...
step('regenerate asset manifest', () => {
  const mediaRoot = join(ROOT, 'media');
  const assets = walkFiles(mediaRoot)
  ...
  writeFileSync(join(ROOT, 'ranuk-manifest.js'), body, 'utf-8');
});
